...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\BE\Machine Learning\Breast_Cancer_Detection_Project\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\BE\Machine Learning\Breast_Cancer_Detection_Project\env\Scripts\deactivate.nu'
